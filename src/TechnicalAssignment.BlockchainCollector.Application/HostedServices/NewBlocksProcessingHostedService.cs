...
public sealed class NewBlocksProcessingHostedService : BackgroundService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly IInternalServiceBus<BlockReceived> _newBlocksServiceBus;
    private readonly ILogger<NewBlocksProcessingHostedService> _logger;

    public NewBlocksProcessingHostedService(
        IServiceProvider serviceProvider,
        IInternalServiceBus<BlockReceived> newBlocksServiceBus,
        ILogger<NewBlocksProcessingHostedService> logger
)
    {
